...
//  Instagram
//
//  Created by Nadia Vedeneyeva on 5/28/21.
//
...
class UserFollowTableViewCell: UITableViewCell {
    ...
    // weak --> not to cause memory leak with two strong references
    ...
    public func configure(with model: UseRelationship) {
        ...
        // Either the loged in user following the model person
        switch model.type {
        case .following:
    ...
    // for the cells being dequeued to be performant nill out subviews
    ...
    override func layoutSubviews() {
        ...
        // contentView.width > 500 implies you are on a iPad
