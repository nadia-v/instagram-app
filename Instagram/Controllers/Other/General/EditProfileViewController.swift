...
final class EditProfileViewController: UIViewController, UITableViewDataSource {
    ...
    private func createTableHeaderView() -> UIView {
        // .integral rounds up all the values to the nearest int
        ...
        // for sothing to happen when the user taps the profile photo
        ...
        profilePhotoButton.setBackgroundImage(UIImage(systemName: "person.circle"),
                                              for: .normal)
        // make tint color label instead of white for it to work in dark/light mode
